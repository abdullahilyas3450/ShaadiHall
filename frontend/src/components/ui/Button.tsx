...
export const Button = ({
  ...
  const variants = {
    ...
    outline: 'border border-gray-300 bg-transparent hover:bg-gray-50 active:scale-95 text-gray-700',
    ghost: 'bg-transparent hover:bg-gray-100 active:scale-95 text-gray-700',
